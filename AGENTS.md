...
## Git
Changes to documentation files in the KOSERVER project root must be committed to the KOSERVER repository.  Any KOPDS or KOSYNC code or documentation changes must be committed to their own separate repositories.
